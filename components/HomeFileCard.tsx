...
const HomeFileCard = ({
    ...
    return (
        <Link
            ...
            target="_blank"
            className="flex items-center gap-3 justify-between rounded-lg bg-white hover:bg-black/10 cursor-pointer p-2 w-full"
        >
            <Thumbnail
                type={file.type}
            ...
            <div className="flex flex-col items-center gap-2 flex-1 line-clamp-1">
                <div className="flex gap-1 items-center w-full">
                    <p className="font-semibold text-lg text-left w-fit line-clamp-1">
                        {file.name}
                    </p>
